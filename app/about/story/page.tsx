...
export const metadata: Metadata = {
  title: "Your Story | The Biology of You",
  description:
    "The story only your biology can tell. Why one-size-fits-all health advice doesn't work, and what makes The Biology of You different.",
};
...
export default function BiologyStoryPage() {
  return (
    <>
      <Nav />
      <main className={styles.about}>
        ...
        >
          ...
          >
            ...
            >
              <p className="eyebrow" style={{ color: "var(--color-card)" }}>Your Story</p>
              <h1 style={{ lineHeight: 1.02, color: "var(--color-card)" }}>The Story Only Your Biology Can Tell</h1>
              <p
                style={{
                  fontSize: "var(--step1)",
